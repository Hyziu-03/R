...
colnames(lesko_p) <- c("I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII")
...
View(select(flights, departure_time=dep_time, scheduled_departure_time=sched_dep_time, departure_delay=dep_delay))
