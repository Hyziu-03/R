...
# przykładowy histogram (z ustawionym zakresem danych i przedziałami,
...
# przykładowy wykres pudełkowy dla jednej zmiennej (z ustawionym
# ręcznie zakresem osi y):
ggplot(katowice_t, aes(I)) +
  geom_boxplot(fill = "orange", color = "blue") +
  scale_y_continuous(limits = c(-1, 1))

# przykładowy wykres pudełkowy dla wielu zmiennych
boxplot(katowice_t[, 2:13],
